...
describe('defaults()', function() {
    ...
    it('- merging two objects with a depth of one, part 1 => ok', function() {
        ...
        var obj2   = {a: 2, b: 3};
        var result = {a: 1, b: 3};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a depth of two, part 1 => ok', function() {
        var obj1   = {a: 1, d: {t: 10}};
        var obj2   = {a: 2, d: {t: 1, a: 9}};
        var result = {a: 1, d: {t: 10, a: 9}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a depth of two, part 2 => ok', function() {
        ...
        var obj1   = {d: {t: 10}};
        var obj2   = {a: 2, d: {t: 1, a: func}};
        var result = {a: 2, d: {t: 10, a: func}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a depth of three, part 1 => ok', function() {
        var obj1   = {a: 1, d: {t: {a: 'test'}}};
        var obj2   = {a: 2, d: {t: 1, a: {p: [1, 2, 3, 4]}}};
        var result = {a: 1, d: {t: {a: 'test'}, a: {p: [1, 2, 3, 4]}}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a depth of three, part 2 => ok', function() {
        var obj1   = {a: 1};
        var obj2   = {a: 2, d: {t: 1, a: {p: 'test'}}};
        var result = {a: 1, d: {t: 1, a: {p: 'test'}}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a array, part 1 => ok', function() {
        var obj1   = {a: [1, 2, 3]};
        var obj2   = {a: 2, d: {t: 1, a: {p: 'test'}}};
        var result = {a: [1, 2, 3], d: {t: 1, a: {p: 'test'}}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects with a array, part 2 => ok', function() {
        var obj1   = {a: [1, 2, 3]};
        var obj2   = {a: 2, d: {t: [1, 3], a: {p: 'test'}}};
        var result = {a: [1, 2, 3], d: {t: [1, 3], a: {p: 'test'}}};
        var actual = tools.defaults(obj1, obj2);

        assert.that(actual).is.equalTo(result);
    });
    it('- merging two objects with a array, part 3 => ok', function() {
        var obj1   = {a: [1, 2, 3], d: {t: ['a']}};
        var obj2   = {a: 2, d: {t: [1, 3], a: {p: 'test'}}};
        var result = {a: [1, 2, 3], d: {t: ['a'], a: {p: 'test'}}};
        var actual = tools.defaults(obj1, obj2);
    ...
    it('- merging two objects and the return is equal to the first object, part 1', function() {
        var obj1   = {a: 1};
        var obj2   = {a: 2, b: 4};
        var actual = tools.defaults(obj1, obj2);

        assert.that(actual).is.sameAs(obj1);
    });
    it('- merging two objects and the return is equal to the first object, part 2', function() {
        var obj1   = {a: {b: 1}};
        var obj2   = {a: {b: 2, d: false}, c: true};
        var actual = tools.defaults(obj1, obj2);

        assert.that(actual.a).is.sameAs(obj1.a);
    });

    it('- merging two objects without to change the array, part 1', function() {
        var obj1   = {a: [1, 2, 3]};
        var obj2   = {a: [6, 7, 8]};
        var actual = tools.defaults(obj1, obj2);

        assert.that(actual.a).is.equalTo(obj1.a);
        assert.that(actual.a).is.sameAs(obj1.a);
    });
    it('- merging two objects without to change the array, part 2', function() {
        var obj1   = {a: {b: [1, 2, 3]}};
        var obj2   = {a: {b: [6, 7, 8]}};
        var actual = tools.defaults(obj1, obj2);

        assert.that(actual.a.b).is.equalTo(obj1.a.b);
        assert.that(actual.a.b).is.sameAs(obj1.a.b);
    });
});
